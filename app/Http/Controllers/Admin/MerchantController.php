...
{
    // View Merchants Index Page
    public function index()
    {
        return view('admin.merchants.index')->withTitle('Merchants');
    }

    // Get Merchants List Data
    public function getData()
    {
        $data = Merchant::select('merchants.*', 'categories.title as cat_name')
            ->leftJoin('categories', 'categories.id', '=', 'merchants.category')
