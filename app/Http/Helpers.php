...
class Helper {
    ...
    public static function getLocation() {
        ...
        if ( $locale == 'de' ) {
            if ( $cur == 'CHF' ) $country_id = 214;
            // Switzerland
            if ( $cur == 'EUR' ) $country_id = 82;
            // Germany
        } elseif ( $locale == 'fr' ) {
            $country_id = 75;
            // France
    ...
    public static function redirectGateway() {
        if ( Session::has( 'offerId' ) ) {
            $offer = offers::where( 'id', Session::get( 'offerId' ) )->get();
            return $offer;
        } else {
        }
    }
