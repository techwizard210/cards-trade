        ...
        columns: [
            {
                ...
                template: function(data) {
                    ...
                    output = '<div class="d-flex align-items-center">\
                            ...
                            <div class="ml-4">\
                                ...
                                <a href="#" class="text-muted font-weight-bold text-hover-primary">' + data.cat_name + '</a>\
                            </div>\
                        </div>';
                    return output;
                },
                ...
                template: function(row) {
                    ...
                    output += '<a href="#" class="font-weight-bolder font-size-lg mb-0">' + row.cat_name + '</a>';
                ...
                template: function(row) {
                    ...
                    output += '<div class="text-danger font-weight-bolder font-size-lg mb-0">$' + row.value + '</div>';
