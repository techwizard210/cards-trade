        ...
        var e = {
            init: function () {
                ...
                Wolmart.call(Wolmart.ratingTooltip, 500),
                                ...
                                success: function (response) {
                                    if(response.status == 'error') {
                                      ...
                                      Wolmart.Minipopup.open({
                                          ...
                                          actionTemplate: '<a href="' + HOST_URL + '/cart" class="btn btn-rounded btn-sm">View Cart</a><a href="' + HOST_URL + '/checkout" class="btn btn-dark btn-rounded btn-sm">Checkout</a>',
                                      });
                    ...
                    Wolmart.$body.on("click", ".wishlist-table .wishlist-action .btn-cart", function (e) {
                        e.preventDefault();
                        var i = t(this),
                            a = i.closest("tr");
                        i.hasClass("disabled")
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    ...
                                    if(response.status == 'error') {
                                        ...
                                        Wolmart.Minipopup.open({
                                            productClass: " product-cart",
                                            name: a.find(".product-name > a").text(),
                                            nameLink: a.find(".product-name > a").attr("href"),
                                            imageSrc: a.find(".product-thumbnail img").attr("src"),
                                            imageLink: a.find(".product-name > a").attr("href"),
                                            message: "<p>has been added to cart:</p>",
                                            actionTemplate: '<a href="' + HOST_URL + '/cart" class="btn btn-rounded btn-sm">View Cart</a><a href="' + HOST_URL + '/checkout" class="btn btn-dark btn-rounded btn-sm">Checkout</a>',
                                        });
                    ...
                    Wolmart.$body.on("click", ".product:not(.product-single) .btn-wishlist:not(.added)", function (e) {
                        e.preventDefault();
                        var i = t(this);
                        i.addClass("load-more-overlay loading")
                        $.ajax({
                            type: "POST",
                            url: HOST_URL + "/addToWishlist",
                            data: {
                                product_id: t(this).attr('data-id')
                            },
                            headers: {
                                'X-CSRF-Token': $('meta[name=csrf_token]').attr('content')
                            },
                            success: function (response) {
                                if(response.status == 'error') {
                                    ...
                                    i.toggleClass("added"), i.toggleClass("w-icon-heart").toggleClass("w-icon-heart-full");
                                } else {
                    ...
                    Wolmart.$body.on("click", ".product:not(.product-single) .btn-wishlist.added", function (e) {
                        e.preventDefault();
                        var i = t(this);
                        i.addClass("load-more-overlay loading")
                        $.ajax({
                            type: "POST",
                            url: HOST_URL + "/removeFromWishlist",
                            data: {
                                product_id: t(this).attr('data-id')
                            },
                            headers: {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if(response.status == 'error') {
                                ...
                                toastr['success'](response.message);
                                i.addClass("added").attr("href", HOST_URL + "/wishlist"), i.toggleClass("w-icon-heart").toggleClass("w-icon-heart-full");
                            } else {
                                toastr['warning']('Something went wrong, please try again.');
                            }
                            i.removeClass("load-more-overlay loading");
        ...
        (e.defaultOptions = {
            ...
            (Wolmart.slideContent = function (e) {
                ...
                i.on("click", function (t) {
                    a.hasClass("open") ? (a.removeClass("open").slideUp(), i.find(".custom-checkbox").removeClass("checked")) : (a.addClass("open").slideDown(), i.find(".custom-checkbox").addClass("checked"));
                });
            }),
