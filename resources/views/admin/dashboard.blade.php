                ...
                <div class="col-xl-3">
                    ...
                    <div class="card card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url(assets/media/svg/shapes/abstract-1.svg)">
                        ...
                        <div class="card-body">
                            ...
                            <span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{ $cnt_merchants }}</span>
                            <span class="font-weight-bold text-muted font-size-sm">Merchants</span>
                        </div>
                        <!--end::Body-->
                    </div>
                    <!--end::Stats Widget 29-->
                ...
                <div class="col-xl-3">
                    ...
                    <div class="card card-custom bg-info card-stretch gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">{{ number_format($cnt_users) }}</span>
                ...
                <div class="col-xl-3">
                    ...
                    <div class="card card-custom bg-danger card-stretch gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">{{ $cnt_cards }}</span>
                            <span class="font-weight-bold text-white font-size-sm">Cards</span>
                        </div>
                        <!--end::Body-->
                    </div>
                    <!--end::Stats Widget 31-->
