            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Cards
                        <span class="d-block text-muted pt-2 font-size-sm">Manage all cards and edit details</span></h3>
                    </div>
...
@push('page-scripts')
    <script type="text/javascript" src="{{ asset('admin-assets/js/pages/cards/index.js') }}"></script>
@endpush
