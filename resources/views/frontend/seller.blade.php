...
<main class="main">
    ...
    <section class="search-section pt-10 pb-10" style="background-image: url({{ asset('user-assets/images/banner.jpg') }});" style="min-height: 40rem">
        <div class="container">
            ...
            <div class="row search-form">
                <div class="col-md-6 col-lg-6">
                    <div class="select-custom">
                        <select class="form-control mb-0" id="seller-merchant-select">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="form-group">
                        <input type="number" class="form-control form-control-md" name="price" placeholder="$ Balance" >
                    </div>
                </div>
                <div class="col-md-12 col-lg-2">
                    <a href="javascript:;"
                        class="btn btn-borders btn-rounded btn-outline-primary ls-25 btn-block">Find Offer Now</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mt-2 mt-lg-10 mb-0 mb-lg-10">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <figure class="br-sm">
                        <img src="{{ asset('user-assets/images/gift-2.jpg') }}" alt="Banner"
                ...
                <div class="col-lg-6 pl-lg-8">
                    ...
                    <p class="mb-6">We provide fastest service and the best rates in the market for your gift cards. Contact us 24/7 to sell your gift cards online instantly.</p>
    ...
    <section class="main-reason-section float-bg lazy-bg" style="background-image: url({{ asset('user-assets/landing/images/reasons/reason-bg.jpg') }});
        ...
        <div class="container">
            <div class="row mb-6">
                <div class="animated-ellipses col-xl-5">
                    ...
                    <div class="ellipse"></div>
                    <div class="ellipse"></div>
                    <div class="count-wrapper appear-animate" data-animation-options="{
                ...
                <div class="col-xl-6 pl-9 pr-10 pt-4 appear-animate" data-animation-options="{
                    'name': 'fadeIn', 'delay': '.5s'
                }">
                    <h3 class="text-white text-capitalize font-weight-bolder ls-10 lh-1 mt-2">How it Works?</h3>
                    <p class="text-white ">We offer the fastest services in the market. Your payment will be transferred within 30Min-2hours(Depending on the card type) after the card is verified.</p>
                </div>
            </div>
                            ...
                            <article class="timeline-box left">
                                <div class="timeline-content">
                                    ...
                                    <div class="appear-animate" data-animation-options="{
                                        ...
                                        <p class="mb-0 text-white">Contact us and One of our representative will assist you at the earliest.</p>
                                    </div>
                                </div>
                                <span class="timeline-node appear-animate" data-animation-options="{
                                    'name': 'fadeInUpShorter', 'delay': '.2s'
                                }">
                                    <img src="{{ asset('user-assets/landing/images/reasons/step1-386x150.png') }}" width="386"
                                        height="150" alt="Timeline Node">
                                </span>
                            </article>
                            <!-- End of Timeline Box -->
                            ...
                            <article class="timeline-box right">
                                <div class="timeline-content">
                                    ...
                                    <div class="appear-animate" data-animation-options="{
                                        ...
                                        <p class="mb-0 text-white">Confirm the Gift Card name and the amount on the Card. Our representative will share the best offer for your card and the payment method by which you want us to pay.</p>
                                    </div>
                                </div>
                                <span class="timeline-node appear-animate" data-animation-options="{
                                    'name': 'fadeInUpShorter', 'delay': '.2s'
                            ...
                            <article class="timeline-box left">
                                <div class="timeline-content">
                                    ...
                                    <div class="appear-animate" data-animation-options="{
                                        ...
                                        <p class="mb-0 text-white"> If you agree with our offer then our representative will ask you to share the card images, receipt, or the e-code. We will then verify the card balance.</p>
                                    </div>
                                </div>
                                <span class="timeline-node appear-animate" data-animation-options="{
                            ...
                            <article class="timeline-box right">
                                <div class="timeline-content">
                                    ...
                                    <div class="appear-animate" data-animation-options="{
                                        ...
                                        <p class="mb-0 text-white">Once we verify the card we will transfer the payment through the payment method you want within 30 minutes.</p>
                                    </div>
                                </div>
                                <span class="timeline-node appear-animate" data-animation-options="{
                                    'name': 'fadeInUpShorter', 'delay': '.3s'
            ...
            <div class="swiper-container swiper-theme show-code-action" data-swiper-options="{
                ...
                <div class="swiper-wrapper row cols-xl-6 cols-lg-5 cols-md-4 cols-sm-3 cols-2">
                    ...
                    <div class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                        <a href="shop-banner-sidebar.html">
                            <figure class="category-media">
                                <img src="{{ asset('user-assets/images/cards/american_express.png') }}" alt="Category"
                                    width="190" height="184" />
                            </figure>
                        </a>
                        <div class="category-content">
    ...
    <section class="cta-section sale-banner-section container mb-10 mt-6 pt-1">
        <div class="sale-banner banner br-sm show-code-action">
            <div class="banner-content">
                <h4
                    class="content-left banner-subtitle text-uppercase mb-8 mb-md-0 mr-0 mr-md-4 text-white ls-25">
                    <span class="ls-normal">High
                        <br>Price</span>Cards!</h4>
                <div class="content-right">
                    <h3
                        class="banner-title text-uppercase font-weight-normal mb-4 mb-md-0 ls-25 text-dark">
                        <span>We Buy
            ...
            <div class="swiper-wrapper row cols-lg-3 cols-sm-2 cols-1">
                    ...
                    <div class="testimonial testimonial-centered testimonial-shadow">
                        <div class="testimonial-info">
                            <figure class="testimonial-author-thumbnail">
                                <img src="{{ asset('user-assets/images/customers/su.jpg') }}" class="rounded-circle" alt="Testimonial"
                ...
                <div class="swiper-slide testimonial-wrap">
                    <div class="testimonial testimonial-centered testimonial-shadow">
                        ...
                        <blockquote>
                            I wanted to sell my $500 apple gift card but was unable to find a buyer. This is the best place to sell your gift card. I got 85% of the value of my card. Thank you so much.
                        </blockquote>
                        <cite>
                ...
                <div class="swiper-slide testimonial-wrap">
                    <div class="testimonial testimonial-centered testimonial-shadow">
                        ...
                        <blockquote>
                            I sold my Ebay Gift card and the response time was fast and they sent the payment within 20 minutes to my cash app. I dint knew that this is possible. Highly recommended.
                        </blockquote>
                        <cite>
