                ...
                <div class="tab-vertical row gutter-lg">
                    ...
                    <div class="tab-content mb-6">
                        <div class="tab-pane active mb-4" id="account-orders">
                            ...
                            <table class="shop-table account-orders-table mb-6">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="order-gateway">Payment method</th>
                                ...
                                <tbody>
                                    @forelse ($orders as $list)
                                        <tr>
                                            ...
                                            <td class="order-status">{{ Config::get("global.{$list->status}") }}</td>
                                            <td class="order-price">
                                                <span class="order-price">${{ number_format($list->amount, 2) }}</span>
                                            </td>
                                            <td class="order-status">{{ Config::get("global.{$list->gateway}") }}</td>
                                            <td class="order-action">
                                                <a href="{{ route('account.order-detail', $list->id) }}"
                            ...
                            <a href="{{ route('buy') }}" class="btn btn-dark btn-rounded btn-icon-right">Go Shop<i
