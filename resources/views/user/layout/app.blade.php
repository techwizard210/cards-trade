...
<head>
    ...
    <style type="text/css">
        .top_head a{color:#000;text-decoration: none;}
    </style>
        ...
        <div class="mobile-menu-wrapper">
            ...
            <nav class="mobile-nav">
                <ul class="mobile-menu">
                    <li><a href="demo6.html">Home</a></li>
                    <li>
                        <a href="demo6-shop.html">Categories</a>
                        <ul>
                    ...
                    <li>
                        <a href="demo6-product.html">Products</a>
                        <ul>
                            <li>
