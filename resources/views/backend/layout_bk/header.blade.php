            ...
            <li class="nav-item dropdown dropdown-user">
                <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="avatar">
                        ...
                        <img class="round" src="{{ asset('admin/app-assets/images/avatars/blank.png') }}" alt="{{ Auth::guard('admin')->user()->name }}" height="40" width="40" />
                        @else
                        <img class="round" src="{{ asset('users/'.Auth::guard('admin')->user()->photo) }}" alt="{{ Auth::guard('admin')->user()->name }}" height="40" width="40" />
                        @endempty
