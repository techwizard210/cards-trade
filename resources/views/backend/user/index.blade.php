...
@push('page-script')
<<<<<<< HEAD:resources/views/backend/pages/user/index.blade.php
    <script src="{{ asset('admin/app-assets/js/pages/user/index.js') }}"></script>
=======
    <script src="{{ asset('admin/app-assets/js/scripts/pages/app-user-list.js') }}"></script>
>>>>>>> parent of 15e2de3 (20211225 update):resources/views/backend/user/index.blade.php
@endpush
