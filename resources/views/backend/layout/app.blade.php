...
<html lang="{{ app()->getLocale() }}">
	<!--begin::Head-->
	<head>
		<title>{{ Helper::getCommonSetting('company_logo_name') }} Admin @isset($title)| {{ $title }} @endisset</title>
	...
	<body id="kt_body" class="page-loading-enabled page-loading header-tablet-and-mobile-fixed aside-enabled">
        <div class="page-loader flex-column">
			<img alt="Logo" class="max-h-75px" src="{{ asset('assets/images/splash-logo.png') }}" width="180">
