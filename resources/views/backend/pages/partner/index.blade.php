...
@push('page-title')
    ...
    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">{{ __('title.partners') }}</h1>
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
        ...
        <li class="breadcrumb-item text-dark">{{ __('title.partners') }}</li>
    </ul>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_brand_table">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.banner.detail', $list->id) }}" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">{{ $list->name }}</a>
                                </td>
                                <td>
                                    <div class="text-muted fs-7 fw-bolder">{{ $list->url }}</div>
                                </td>
                                <td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        <div class="menu-item px-3">
                                            <a href="javascript:;" class="menu-link px-3 btn-edit-partner" data-id="{{ $list->id }}">{{ __('title.buttons.edit') }}</a>
                                        </div>
                                        <div class="menu-item px-3">
...
@push('page-script')
    <script src="{{ asset('admin-assets/js/pages/partner/index.js') }}"></script>
