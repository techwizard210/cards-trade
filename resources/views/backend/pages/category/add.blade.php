...
@push('page-title')
    ...
    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">{{ __('title.new_category') }}</h1>
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
        ...
        <li class="breadcrumb-item text-dark">{{ __('title.new_category') }}</li>
    </ul>
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10" data-kt-redirect="{{ route('admin.category.index') }}">
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="card card-flush py-4 pb-20">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="category_name" class="form-control mb-2" placeholder="{{ __('label.name') }}" value="" />
                            ...
                            <div>
                                ...
                                <textarea class="form-control" rows="5" placeholder="{{ __('message.type_text_here') }}..." name="category_description"></textarea>
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <a href="{{ route('admin.category.index') }}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">{{ __('title.buttons.cancel') }}</a>
...
@push('page-script')
    <script src="{{ asset('admin-assets/js/pages/category/add.js') }}"></script>
@endpush
