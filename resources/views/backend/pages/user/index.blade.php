...
@push('page-title')
    ...
    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">{{ __('title.customers') }}</h1>
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
        ...
        <li class="breadcrumb-item text-dark">{{ __('title.customers') }}</li>
    </ul>
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="{{ __('label.search') }}..." />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-80px">{{ __('label.country') }}</th>
                                <th class="min-w-80px">{{ __('label.phone') }}</th>
                                <th class="min-w-70px">{{ __('label.status') }}</th>
                                <th class="min-w-125px">{{ __('label.created_at') }}</th>
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                        <a href="{{ route('admin.user.detail', $list->id) }}">
                                            @empty($list->photo)
                                            <div class="symbol-label fs-3 bg-light-{{ $state = Helper::getRandomStatus() }} text-{{ $state }}">
                                                @if(!empty($list->first_name) && !empty($list->last_name)) {{ ucfirst($list->first_name[0]).ucfirst($list->last_name[0]) }}
                                                @else {{ ucfirst($list->name[0]) }}
                                                @endif
                                            </div>
                                            @else
                                            <div class="symbol-label">
                                                <img src="{{ asset('users/'.$list->photo) }}" alt="{{ $list->name }}" class="w-100">
                                            </div>
                                            @endempty
                                        </a>
                                    </div>
                                    <div class="d-flex flex-column">
                                        <a href="{{ route('admin.user.detail', $list->id) }}" class="text-gray-800 text-hover-primary mb-1 td-user-name">{{ $list->name }}
                                            @if($list->email_verified)
                                ...
                                <td>
                                    <a href="javascript:;" class="text-gray-600 text-hover-primary mb-1">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1" src="{{ asset('admin-assets/media/flags/'.str_replace(' ', '-', strtolower(Helper::getCountryById($list->country)->name)).'.svg') }}" alt="German" data-xblocker="passed" style="visibility: visible;">
                                        </span>
                                        {{ Helper::getCountryById($list->country)->name }}
                                    </a>
                                </td>
                                <td>
                                    <div>{{ empty($list->phone)?'-':$list->phone }}</div>
                                </td>
                                <td data-filter="mastercard">
                                    @if($list->status == 'active')
                                    <div class="badge badge-light-success fw-bolder">{{ __('label.active') }}</div>
                                    @else
                                    <div class="badge badge-light-danger fw-bolder">{{ __('label.inactive') }}</div>
                                    @endif
                                </td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('admin.user.detail', $list->id) }}" class="menu-link px-3">{{ __('title.buttons.view') }}</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3" data-kt-customer-table-filter="delete_row" data-id="{{ $list->id }}">{{ __('title.buttons.delete') }}</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    <!--end::Menu-->
            ...
            <div class="modal fade" id="kt_modal_import_products" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    <div class="modal-content">
                        <form class="form" action="#" id="kt_modal_import_products_form" data-kt-redirect="{{ route('admin.user.index') }}">
                            @csrf
...
@push('page-script')
    <script src="{{ asset('admin-assets/js/pages/user/index.js') }}"></script>
