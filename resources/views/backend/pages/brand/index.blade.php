...
@push('page-title')
    ...
    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">{{ __('title.brands') }}</h1>
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
        ...
        <li class="breadcrumb-item text-dark">{{ __('title.brands') }}</li>
    </ul>
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('admin.brand.add') }}" class="btn btn-primary">{{ __('title.new_brand') }}</a>
                    </div>
                </div>
                <!--end::Card header-->
                <!--begin::Card body-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_brand_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-250px">{{ __('label.brand') }}</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="{{ route('admin.brand.detail', $list->id) }}" class="symbol symbol-50px symbol-2by3">
                                            @empty($list->brand_logo)
                                                <span class="symbol-label" style="background-image:url({{ asset('admin-assets/media/product-default.png') }});"></span>
                                            @else
                                                <span class="symbol-label" style="background-image:url({{ asset('brands/'.$list->brand_logo) }});"></span>
                                            @endempty
                                        </a>
                                        <div class="ms-5">
                                            <a href="{{ route('admin.brand.detail', $list->id) }}" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">{{ $list->title }}</a>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        <div class="menu-item px-3">
                                            <a href="{{ route('admin.brand.detail', $list->id) }}" class="menu-link px-3">{{ __('title.buttons.edit') }}</a>
                                        </div>
                                        <div class="menu-item px-3">
...
@push('page-script')
    <script src="{{ asset('admin-assets/js/pages/brand/index.js') }}"></script>
@endpush
