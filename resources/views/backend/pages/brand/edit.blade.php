...
@push('page-title')
    ...
    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">{{ __('label.brand') }} - {{ $content->title }}</h1>
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
        ...
        <li class="breadcrumb-item text-dark">{{ __('label.brand') }} - {{ $content->title }}</li>
    </ul>
            ...
            <form id="kt_ecommerce_update_brand_form" class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10" data-kt-redirect="{{ route('admin.brand.index') }}">
                ...
                <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body text-center pt-0">
                            <!--begin::Image input-->
                            <div class="image-input {{ !empty($content->brand_logo)?'':'image-input-empty' }} image-input-outline mb-3" data-kt-image-input="true" style="background-image: url({{ asset('admin-assets/media/svg/files/blank-image.svg') }})">
                                @empty($content->brand_logo)
                                <div class="image-input-wrapper w-150px h-150px"></div>
                                @else
                                <div class="image-input-wrapper w-150px h-150px" style="background-image: url({{ asset('brands/'.$content->brand_logo) }})"></div>
                                @endempty
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="card card-flush py-4 pb-20">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="brand_name" class="form-control mb-2" placeholder="{{ __('label.name') }}" value="{{ $content->title }}" />
                            ...
                            <div>
                                ...
                                <textarea class="form-control" rows="5" placeholder="{{ __('message.type_text_here') }}..." name="description">{{ $content->description }}</textarea>
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <a href="{{ route('admin.brand.index') }}" id="kt_ecommerce_update_product_cancel" class="btn btn-light me-5">{{ __('title.buttons.cancel') }}</a>
...
@push('page-script')
    <script src="{{ asset('admin-assets/js/pages/brand/edit.js') }}"></script>
@endpush
