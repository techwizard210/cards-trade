...
@push('page-title')
    ...
    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">{{ __('title.new_banner') }}</h1>
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
        ...
        <li class="breadcrumb-item text-dark">{{ __('title.new_banner') }}</li>
    </ul>
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <form id="kt_ecommerce_add_brand_form" class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10" data-kt-redirect="{{ route('admin.banner.index') }}">
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="card card-flush py-4 pb-20">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-5 fv-row">
                                ...
                                <input type="text" name="title" class="form-control mb-2" placeholder="{{ __('label.title') }}" value="" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-5 fv-row">
                                <label class="required form-label">{{ __('label.subtitle') }}</label>
                                <input type="text" name="subtitle" class="form-control mb-2" placeholder="{{ __('label.subtitle') }}" value="" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-5 fv-row">
                                <label class="required form-label">{{ __('label.description') }} 1</label>
                                <input type="text" name="description1" class="form-control mb-2" placeholder="{{ __('label.description') }} 1" value="" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-5 fv-row">
                                <label class="required form-label">{{ __('label.description') }} 2</label>
                                <input type="text" name="description2" class="form-control mb-2" placeholder="{{ __('label.description') }} 2" value="" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-5 fv-row">
                                <label class="required form-label">{{ __('label.description') }} 3</label>
                                <input type="text" name="description3" class="form-control mb-2" placeholder="{{ __('label.description') }} 3" value="" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-5 fv-row">
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <a href="{{ route('admin.banner.index') }}" id="kt_ecommerce_add_brand_cancel" class="btn btn-light me-5">{{ __('title.buttons.cancel') }}</a>
...
@push('page-script')
    <script src="{{ asset('admin-assets/js/pages/banner/add.js') }}"></script>
@endpush
